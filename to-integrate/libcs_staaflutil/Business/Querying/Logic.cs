...
namespace Screens
{
    ...
    static class Logic
    {
        public static bool Test() {
            ...
            bool alloc = NativeMethods.AllocConsole();
            int balance = 100;
            int age = 30;
            string title = "mrs";
        ...
        //public static IEnumerable<string> Parse<T>(IEnumerable<LogicWrapper> collection, String condition)
        //where T : IComparable {
        //    Stack<Predicate<bool>> stack = new Stack<Predicate<bool>>();
        ...
        //        //    }
        //        //}
        //        //else if (ch_num.Contains(cond[ii])) {
        //        //    ++ii;
        //        //}
        //        else if (cond[ii] == ';') {
        //            result = temp1(op(leftOp, rightOp)).And()(true);
        ...
        //    return collection.Select(v => v.InnerObject);
        //}
