...
{
    public class SetupData : Sage_Container, IData
    {
        /* Autogenerated by sage_wrapper_generator.pl */
        SageDataObject110.SetupData sd11;
        SageDataObject120.SetupData sd12;
        SageDataObject130.SetupData sd13;
        SageDataObject140.SetupData sd14;
        SageDataObject150.SetupData sd15;
        SageDataObject160.SetupData sd16;
        SageDataObject170.SetupData sd17;


        public SetupData(object inner, int version)
            : base(version) {
            switch (m_version) {
            case 11: {
                    sd11 = (SageDataObject110.SetupData)inner;
                    m_fields = new Fields(sd11.Fields,m_version);
                    return;
                }

            case 12: {
                    sd12 = (SageDataObject120.SetupData)inner;
                    m_fields = new Fields(sd12.Fields,m_version);
                    return;
                }

            case 13: {
                    sd13 = (SageDataObject130.SetupData)inner;
                    m_fields = new Fields(sd13.Fields,m_version);
                    return;
                }

            case 14: {
                    sd14 = (SageDataObject140.SetupData)inner;
                    m_fields = new Fields(sd14.Fields,m_version);
                    return;
                }

            case 15: {
                    sd15 = (SageDataObject150.SetupData)inner;
                    m_fields = new Fields(sd15.Fields,m_version);
                    return;
                }
            case 16: {
                    sd16 = (SageDataObject160.SetupData)inner;
                    m_fields = new Fields(sd16.Fields,m_version);
                    return;
                }
            case 17: {
                    sd17 = (SageDataObject170.SetupData)inner;
        ...
        const string SETUPDATA = "SetupData";
