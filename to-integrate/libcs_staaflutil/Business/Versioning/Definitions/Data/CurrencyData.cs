...
{
    public class CurrencyData : Sage_Container, IData
    {
        /* Autogenerated by sage_wrapper_generator.pl */
        SageDataObject110.CurrencyData cd11;
        SageDataObject120.CurrencyData cd12;
        SageDataObject130.CurrencyData cd13;
        SageDataObject140.CurrencyData cd14;
        SageDataObject150.CurrencyData cd15;
        SageDataObject160.CurrencyData cd16;
        SageDataObject170.CurrencyData cd17;


        public CurrencyData(object inner, int version)
            : base(version) {
            switch (m_version) {
            case 11: {
                    cd11 = (SageDataObject110.CurrencyData)inner;
                    m_fields = new Fields(cd11.Fields,m_version);
                    return;
                }

            case 12: {
                    cd12 = (SageDataObject120.CurrencyData)inner;
                    m_fields = new Fields(cd12.Fields,m_version);
                    return;
                }

            case 13: {
                    cd13 = (SageDataObject130.CurrencyData)inner;
                    m_fields = new Fields(cd13.Fields,m_version);
                    return;
                }

            case 14: {
                    cd14 = (SageDataObject140.CurrencyData)inner;
                    m_fields = new Fields(cd14.Fields,m_version);
                    return;
                }

            case 15: {
                    cd15 = (SageDataObject150.CurrencyData)inner;
                    m_fields = new Fields(cd15.Fields,m_version);
                    return;
                }
            case 16: {
                    cd16 = (SageDataObject160.CurrencyData)inner;
                    m_fields = new Fields(cd16.Fields,m_version);
                    return;
                }
            case 17: {
                    cd17 = (SageDataObject170.CurrencyData)inner;
        ...
        const string CURRENCYDATA = "CurrencyData";
