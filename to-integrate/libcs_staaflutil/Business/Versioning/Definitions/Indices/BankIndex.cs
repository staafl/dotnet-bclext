...
{
    public class BankIndex : Sage_Container, IData, IFind, IIndex
    {
        SageDataObject110.BankIndex rd11;
        SageDataObject120.BankIndex rd12;
        SageDataObject130.BankIndex rd13;
        SageDataObject140.BankIndex rd14;
        SageDataObject150.BankIndex rd15;
        SageDataObject160.BankIndex rd16;
        SageDataObject170.BankIndex rd17;
        Type _type;
        Object _object;

        /* Autogenerated with data_generator.pl */
        const string ACCOUNT_REF = "ACCOUNT_REF";
        const string STOCK_INDEX = "BankIndex";



        public BankIndex(object a, int version)
            : base(version) {
            switch (m_version) {
                case 11:
                    rd11 = (SageDataObject110.BankIndex)a;
                    _type = rd11.GetType();
                    _object = rd11;
                    break;
                case 12:
                    rd12 = (SageDataObject120.BankIndex)a;
                    _type = rd12.GetType();
                    _object = rd12;

                    break;
                case 13:
                    rd13 = (SageDataObject130.BankIndex)a;
                    _type = rd13.GetType();
                    _object = rd13;

                    break;
                case 14:
                    rd14 = (SageDataObject140.BankIndex)a;
                    _type = rd14.GetType();
                    _object = rd14;

                    break;
                case 15:
                    rd15 = (SageDataObject150.BankIndex)a;
                    _type = rd15.GetType();
                    _object = rd15;

                    break;
                case 16:
                    rd16 = (SageDataObject160.BankIndex)a;
                    _type = rd16.GetType();
                    _object = rd16;

                    break;
                case 17:
                    rd17 = (SageDataObject170.BankIndex)a;
                    _type = rd17.GetType();
                    _object = rd17;
