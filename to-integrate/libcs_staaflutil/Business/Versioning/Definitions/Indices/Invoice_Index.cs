...
{
    public class InvoiceIndex : Sage_Container, IData, IFind
    {
        SageDataObject110.InvoiceIndex rd11;
        SageDataObject120.InvoiceIndex rd12;
        SageDataObject130.InvoiceIndex rd13;
        SageDataObject140.InvoiceIndex rd14;
        SageDataObject150.InvoiceIndex rd15;
        SageDataObject160.InvoiceIndex rd16;
        SageDataObject170.InvoiceIndex rd17;
        Type _type;
        Object _object;

        /* Autogenerated with data_generator.pl */
        const string ACCOUNT_REF = "ACCOUNT_REF";
        const string INVOICE_INDEX = "InvoiceIndex";
        ...
        public InvoiceIndex(object a, int version)
            : base(version) {
            switch (m_version) {
                case 11:
                    rd11 = (SageDataObject110.InvoiceIndex)a;
                    _type = rd11.GetType();
                    _object = rd11;
                    break;
                case 12:
                    rd12 = (SageDataObject120.InvoiceIndex)a;
                    _type = rd12.GetType();
                    _object = rd12;

                    break;
                case 13:
                    rd13 = (SageDataObject130.InvoiceIndex)a;
                    _type = rd13.GetType();
                    _object = rd13;

                    break;
                case 14:
                    rd14 = (SageDataObject140.InvoiceIndex)a;
                    _type = rd14.GetType();
                    _object = rd14;

                    break;
                case 15:
                    rd15 = (SageDataObject150.InvoiceIndex)a;
                    _type = rd15.GetType();
                    _object = rd15;

                    break;
                case 16:
                    rd16 = (SageDataObject160.InvoiceIndex)a;
                    _type = rd16.GetType();
                    _object = rd16;

                    break;
                case 17:
                    rd17 = (SageDataObject170.InvoiceIndex)a;
                    _type = rd17.GetType();
                    _object = rd17;
        ...
        public int DataRecordNumber {
            get {
                return (int)_type.InvokeMember(
                      "DataRecordNumber", BindingFlags.GetProperty, null, _object, new Object[0]);
            }
        }
        ...
        public int IndexRecordNumber {
            get {
                return (int)_type.InvokeMember(
                      "IndexRecordNumber", BindingFlags.GetProperty, null, _object, new Object[0]);
            }
        }
        ...
        public object ObjKey {
            get {
                return _type.InvokeMember("Key", BindingFlags.GetProperty, null, _object, new Object[0]);
            }
            set {
