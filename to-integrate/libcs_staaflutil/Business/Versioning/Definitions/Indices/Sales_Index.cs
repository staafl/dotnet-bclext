...
{
      public class SalesIndex : Sage_Container, IData, IFind, IIndex
      {
            SageDataObject110.SalesIndex rd11;
            SageDataObject120.SalesIndex rd12;
            SageDataObject130.SalesIndex rd13;
            SageDataObject140.SalesIndex rd14;
            SageDataObject150.SalesIndex rd15;
            SageDataObject160.SalesIndex rd16;
            SageDataObject170.SalesIndex rd17;
            Type _type;
            Object _object;

            /* Autogenerated with data_generator.pl */
            const string ACCOUNT_REF = "ACCOUNT_REF";
            const string STOCK_INDEX = "SalesIndex";
    
      
            


            public SalesIndex(object a, int version)
                  : base(version) {
                  switch (m_version) {
                        case 11:
                              rd11 = (SageDataObject110.SalesIndex)a;
                              _type = rd11.GetType();
                              _object = rd11;
                              break;
                        case 12:
                              rd12 = (SageDataObject120.SalesIndex)a;
                              _type = rd12.GetType();
                              _object = rd12;

                              break;
                        case 13:
                              rd13 = (SageDataObject130.SalesIndex)a;
                              _type = rd13.GetType();
                              _object = rd13;

                              break;
                        case 14:
                              rd14 = (SageDataObject140.SalesIndex)a;
                              _type = rd14.GetType();
                              _object = rd14;

                              break;
                        case 15:
                              rd15 = (SageDataObject150.SalesIndex)a;
                              _type = rd15.GetType();
                              _object = rd15;

                              break;
                        case 16:
                              rd16 = (SageDataObject160.SalesIndex)a;
                              _type = rd16.GetType();
                              _object = rd16;

                              break;
                        case 17:
                              rd17 = (SageDataObject170.SalesIndex)a;
                              _type = rd17.GetType();
                              _object = rd17;
