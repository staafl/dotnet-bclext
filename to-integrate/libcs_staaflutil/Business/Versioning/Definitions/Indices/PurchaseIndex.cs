...
{
    public class PurchaseIndex : Sage_Container, IData, IFind, IIndex
    {
        SageDataObject110.PurchaseIndex rd11;
        SageDataObject120.PurchaseIndex rd12;
        SageDataObject130.PurchaseIndex rd13;
        SageDataObject140.PurchaseIndex rd14;
        SageDataObject150.PurchaseIndex rd15;
        SageDataObject160.PurchaseIndex rd16;
        SageDataObject170.PurchaseIndex rd17;
        Type _type;
        Object _object;

        /* Autogenerated with data_generator.pl */
        const string ACCOUNT_REF = "ACCOUNT_REF";
        const string STOCK_INDEX = "PurchaseIndex";



        public PurchaseIndex(object a, int version)
            : base(version) {
            switch (m_version) {
                case 11:
                    rd11 = (SageDataObject110.PurchaseIndex)a;
                    _type = rd11.GetType();
                    _object = rd11;
                    break;
                case 12:
                    rd12 = (SageDataObject120.PurchaseIndex)a;
                    _type = rd12.GetType();
                    _object = rd12;

                    break;
                case 13:
                    rd13 = (SageDataObject130.PurchaseIndex)a;
                    _type = rd13.GetType();
                    _object = rd13;

                    break;
                case 14:
                    rd14 = (SageDataObject140.PurchaseIndex)a;
                    _type = rd14.GetType();
                    _object = rd14;

                    break;
                case 15:
                    rd15 = (SageDataObject150.PurchaseIndex)a;
                    _type = rd15.GetType();
                    _object = rd15;

                    break;
                case 16:
                    rd16 = (SageDataObject160.PurchaseIndex)a;
                    _type = rd16.GetType();
                    _object = rd16;

                    break;
                case 17:
                    rd17 = (SageDataObject170.PurchaseIndex)a;
                    _type = rd17.GetType();
                    _object = rd17;
